...
def classify_image_using_MobileNet(image):
    ...
    # since the model expects batched input
...
def home():
    ...
    # and set the default model to 'mobile'
...
def classifyUsingMobileNetV2():
    # Declare global variables to hold image, 
    # label and base64 data
...
def thanks_for_feedback_incorrect():
    if request.method == 'POST':
        ...
        # but you can extend this to improve your model
